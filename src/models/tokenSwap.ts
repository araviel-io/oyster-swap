...
export const legacyDepositInstruction = (
  tokenSwap: PublicKey,
  authority: PublicKey,
...
export const legacyDepositExactOneInstruction = (
  tokenSwap: PublicKey,
  authority: PublicKey,
  transferAuthority: PublicKey,
  source: PublicKey,
...
export const legacyWithdrawInstruction = (
  tokenSwap: PublicKey,
  authority: PublicKey,
  transferAuthority: PublicKey,
  poolMint: PublicKey,
...
export const legacyWithdrawExactOneInstruction = (
  tokenSwap: PublicKey,
  authority: PublicKey,
  transferAuthority: PublicKey,
  poolMint: PublicKey,
...
export const legacySwapInstruction = (
  tokenSwap: PublicKey,
  authority: PublicKey,
  transferAuthority: PublicKey,
...
// TODO: Implement each static method to map to legacy instruction
