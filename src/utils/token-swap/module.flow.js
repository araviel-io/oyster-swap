...
declare export var TOKEN_SWAP_PROGRAM_ID: PublicKey;
/**
 * Some amount of tokens
 */
declare export class Numberu64 mixins BN {
  /**
...
declare export var TokenSwapLayout: any;
declare export var CurveType: $ReadOnly<{
