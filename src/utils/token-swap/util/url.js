...
exports.url = process.env.RPC_URL ||
    (process.env.LIVE ? (0, web3_js_1.clusterApiUrl)(exports.cluster, false) : 'http://localhost:8328');
exports.urlTls = process.env.RPC_URL ||
    (process.env.LIVE ? (0, web3_js_1.clusterApiUrl)(exports.cluster, true) : 'http://localhost:8328');
